\begin{appendices}
  \addtocontents{toc}{\protect\setcounter{tocdepth}{1}}
    ...
    \chapter{Evaluation Questionnaire Layouts \label{app:evaluation-questionnaire-layouts}}
      \TBox[fill=red!15]{13cm}{
        ...
        \TBox[fill=black!1]{12.7cm}{
          ...
          \TBox[fill=pink!25]{6cm}{
            Layout Summary (Topic B)
          }
          \TBox[fill=pink!25]{6cm}{
            Stock Summary (Topic B)
          }
          \TBoxDash[fill=black!15]{12.4cm}{
            \textit{4 factor ratings; overall rating \& free text comment}
          }
